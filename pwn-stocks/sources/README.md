...
2. Clone the service `git clone your-service-repo && cd your-service-repo && cd third_party && git clone https://github.com/userver-framework/userver/ && cd userver && git checkout 3a78ec69918e204b210b2e9183f38a2c52f327d6 && cd ../.. && git clone https://github.com/m4drat/spark-jit/ && cd spark-jit && git checkout dde114cedbcb52f4e67ed43a53b35249a5ccf3b0 && cd ..`
