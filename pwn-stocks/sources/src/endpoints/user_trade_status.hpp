...
namespace tt { namespace endpoints {
    ...
    class TradeStatusHandler final : public server::handlers::HttpHandlerJsonBase
    {
    public:
        static constexpr std::string_view kName = "handler-user-trade-status";

        TradeStatusHandler(const components::ComponentConfig& config,
        ...
        {
            try {
                auto request_dom = json.As<TradeStatusRequestBody>();
                auto response_dom = TradeStatus(request_dom, context);
    ...
    private:
        ...
        TradeStatusResponseBody TradeStatus(
