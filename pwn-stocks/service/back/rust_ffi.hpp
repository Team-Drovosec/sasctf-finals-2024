 ...
 */
[[nodiscard]] void *compile_expression(const char *input, char *code_integrity,
 ...
 */
int64_t evaluate_expression(void *exe, const char *const keys_ptr[],
                            const int64_t *values_ptr,
                            std::size_t variables_len, char *output_error,
                            std::size_t output_error_len);
